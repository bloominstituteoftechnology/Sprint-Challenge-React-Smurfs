...
When a page is refreshed or when clicking on a new link, a whole new document is served to the user with the server-side routing, while with the client-side routing will only change whats requested.
