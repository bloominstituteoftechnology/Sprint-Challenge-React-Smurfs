...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      <div className="App">
        <Route exact path="/smurfs" render={(props) => <Smurfs {...props} deleteHandler={this.deleteHandler} smurfs={this.state.smurfs} />} />
        <Route exact path='/smurf-form' render={(props) => <SmurfForm className='form' {...props} smurfs={this.state.smurfs}/>} />
        <Route exact path="/smurf-form" render={(props) => <Smurfs {...props} deleteHandler={this.deleteHandler} smurfs={this.state.smurfs} />} />
      </div>
      </div>
    )
  }
