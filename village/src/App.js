      ...
      <div className="App">
        <header>
          <div className="navigation container">
            ...
            <NavLink to='/smurfform' activeClassName="active">New Smurf</NavLink>
          </div>
        </header>
        <section className="main-content container">
          {this.state.smurfs.length === 0 ? <Route exact path='/' component={Intro} />: <Route exact path='/' render={props =>
             <Smurfs 
             {...props} 
