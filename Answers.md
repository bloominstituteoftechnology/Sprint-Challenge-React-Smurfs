(1) Client-side-routing has data on a client browser which updates/changes     dynamically based on the process, which alter the state of components      on a page.
